...
struct  TurnBasedMatchOutcome_t3014500315 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(TurnBasedMatchOutcome_t3014500315, ___value___1)); }
