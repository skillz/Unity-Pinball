...
#include "UnityEngine_UnityEngine_jvalue3412352577MethodDeclarations.h"
...
extern "C" void jvalue_t3412352577_marshal_pinvoke_back(const jvalue_t3412352577_marshaled_pinvoke& marshaled, jvalue_t3412352577& unmarshaled)
{
	...
	IntPtr_t unmarshaled_l_temp_8_temp;
	unmarshaled_l_temp_8_temp.set_m_value_0(reinterpret_cast<void*>((intptr_t)(marshaled.___l_8)));
	unmarshaled_l_temp_8 = unmarshaled_l_temp_8_temp;
...
extern "C"  void Rigidbody2D_AddTorque_m775750448 (Rigidbody2D_t502193897 * __this, float ___torque0, const MethodInfo* method)
{
	int32_t V_0 = 0;
	{
		V_0 = 0;
		...
		int32_t L_1 = V_0;
		Rigidbody2D_AddTorque_m714733013(__this, L_0, L_1, /*hidden argument*/NULL);
		return;
	}
}
